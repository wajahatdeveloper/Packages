namespace SheetCodesEditor
{
    public static class SheetStringDefinitions
    {
        ...
        public const string TEMPLATE_FILE_RECORD_COPYPROPERTY = "TemplateRecordCopyProperty.txt";
        ...
        public const string TEMPLATE_FILE_RECORD_STRONGREFERENCE = "TemplateRecordStrongReference.txt";
        public const string TEMPLATE_FILE_RECORD_STRONGREFERENCE_COLLECTION = "TemplateRecordStrongReferenceCollection.txt";

        public const string TEMPLATE_FILE_RECORD_ENUM = "TemplateRecordEnum.txt";
        public const string TEMPLATE_FILE_RECORD_ENUM_COLLECTION = "TemplateRecordEnumCollection.txt";
        ...
        public const string TEMPLATE_INSERT_COPYPROPERTIES = "/*COPY_PROPERTIES*/";
