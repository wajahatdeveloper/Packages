...
namespace Sisus
{
	...
	{
		/// <summary> Unique ID for a control generated using GUIUtility.GetControlID. </summary>
		int ControlID { get; }
		...
		/// <summary>
		/// Gets the UnityEngine.Object targets of the drawer.
		/// 
		...
		/// </summary>
		/// <value>
		/// The UnityEngine.Object targets
		/// </value>
		[NotNull]
		...
		/// For IGameObjectDrawer this returns the first target GameObject.
		/// For IAssetDrawer this returns null.
		/// For static classes this returns null.
		/// For IFieldDrawer this requests Transform from parent.
		/// </summary>
		...
		/// <summary>
		/// Gets instance of default value for these drawers.
