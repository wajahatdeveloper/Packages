...
namespace Sisus
{
	...
	public interface IDrawerProvider : IDrawerByNameProvider
	{
		...
		[NotNull]
		Type GetClassDrawerType([NotNull]Type classType);
		...
		/// <returns> Type of drawer class that implements IDrawer. </returns>
		[NotNull]
		Type GetClassMemberDrawerType([NotNull]Type fieldType);
		...
		[NotNull]
		ICustomEditorAssetDrawer GetForAssetWithEditor([NotNull]Type drawerType, [CanBeNull]Type customEditorType, [NotNull]Object[] targets, [CanBeNull]Object[] assetImporters, [CanBeNull]IParentDrawer parent, [NotNull]IInspector inspector);
		#endif
		...
		[CanBeNull]
		IDrawer GetForFields([NotNull]object[] values, IParentDrawer parent, GUIContent label = null, bool readOnly = false);
		...
		/// <returns> The drawer instance, ready to be used. This will never be null. </returns>
		[CanBeNull]
		IDrawer GetForField([NotNull]LinkedMemberInfo memberInfo, IParentDrawer parent, GUIContent label = null, bool readOnly = false);
		...
		/// <returns> The drawer instance, ready to be used. This will never be null. </returns>
		[NotNull]
		IDrawer GetForField([CanBeNull]object value, [CanBeNull]LinkedMemberInfo memberInfo, [CanBeNull]IParentDrawer parent, [CanBeNull]GUIContent label, bool readOnly);
		...
		/// <returns> The drawer instance, ready to be used. This will never be null. </returns>
		[NotNull]
		IDrawer GetForField([CanBeNull]object value, [NotNull]Type fieldType, [CanBeNull]LinkedMemberInfo memberInfo, [CanBeNull]IParentDrawer parent, [CanBeNull]GUIContent label, bool readOnly);
		...
		/// <returns> The drawer instance, ready to be used. This will never be null. </returns>
		[NotNull]
		IFieldDrawer GetForProperty([CanBeNull]object value, [NotNull]Type valueType, [NotNull]LinkedMemberInfo memberInfo, [CanBeNull]IParentDrawer parent, [CanBeNull]GUIContent label, bool readOnly);
		...
		/// <returns> The drawer instance, ready to be used. This will never be null. </returns>
		[NotNull]
		IDrawer GetForPropertyDrawer([NotNull]Attribute fieldAttribute, [CanBeNull]object value, [NotNull]Type fieldType, [CanBeNull]LinkedMemberInfo memberInfo, [CanBeNull]IParentDrawer parent, [CanBeNull]GUIContent label, bool readOnly);
		...
		/// <returns> The drawer instance, ready to be used. This will never be null. </returns>
		[NotNull]
		IDrawer GetForMethod(LinkedMemberInfo methodInfo, IParentDrawer parent, GUIContent label = null, bool readOnly = false);
