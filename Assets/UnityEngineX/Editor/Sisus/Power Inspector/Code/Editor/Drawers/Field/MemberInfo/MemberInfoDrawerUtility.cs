...
namespace Sisus
{
	...
	public static class MemberInfoDrawerUtility
	{
		...
		public static List<PopupMenuItem> allRootItems = new List<PopupMenuItem>(50);
		...
		public static List<PopupMenuItem> fieldRootItems = new List<PopupMenuItem>(50);
		...
		public static List<PopupMenuItem> propertyRootItems = new List<PopupMenuItem>(50);
		...
		public static List<PopupMenuItem> methodRootItems = new List<PopupMenuItem>(50);
