...
namespace Sisus
{
	public static class Attribute<TAttribute> where TAttribute : Attribute
	{
		...
		private static readonly System.Collections.Concurrent.ConcurrentDictionary<MemberInfo, IEnumerable<TAttribute>> cache = new System.Collections.Concurrent.ConcurrentDictionary<MemberInfo, IEnumerable<TAttribute>>(4, 1024);
		private static readonly System.Collections.Concurrent.ConcurrentDictionary<Type, IEnumerable<TAttribute>> cacheForClasses = new System.Collections.Concurrent.ConcurrentDictionary<Type, IEnumerable<TAttribute>>(4, 1024);
		#endif
