...
namespace MalbersAnimations.Selector
{
    ...
    public class SelectorManagerEditor : Editor
    {
        ...
        SerializedProperty enableSelector, DontDestroy, ItemSelected, OriginalItemSelected, InstantiateItems, SpawnPoint, RemoveLast, DontDestroySelectedItem,
            ShowAnims, Target, EnterAnimation, ExitAnimation, Data, OnSelected, OnOpen, OnClosed, OnDataChanged, ShowEvents;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.BeginVertical(MalbersEditor.StyleGray);
            {
                ...
                InstantiateItems.boolValue = EditorGUILayout.ToggleLeft(new GUIContent("Instantiate Item", "Insantiate the original prefab of the selected item"), InstantiateItems.boolValue, GUILayout.MinWidth(80));
                ...
                ShowAnims.boolValue = EditorGUILayout.Foldout(ShowAnims.boolValue, "Animate Open/Close");
                EditorGUI.indentLevel--;

                if (ShowAnims.boolValue)
                {
                    EditorGUILayout.PropertyField(Target, new GUIContent("Target to Animate", "This is the Transform to animate In and Out"), GUILayout.MinWidth(50));
                ...
                if (Data.objectReferenceValue != null && M.Data != null)
                {
                ...
                {
                    if (GUILayout.Button(new GUIContent("Sa ve Default Data", "Store all the Items Values and Coins as the Restore/Default Data")))
                    {
                        M.SaveDefaultData();
                        if (Data.objectReferenceValue != null)
                        {
