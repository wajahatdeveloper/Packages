...
namespace MalbersAnimations.Selector
{
    ...
    public class SelectorControllerEditor : Editor
    {
        ...
        SerializedProperty RestoreTime, AnimateSelection, SoloSelection, SelectionTime, SelectionCurve, DragSpeed, dragHorizontal, inertia, inertiaTime, minInertiaSpeed, inertiaCurve,
            ...
            EditorInput, EditorAdvanced, ClickToFocus, ChangeOnEmptySpace, Threshold, EditorShowEvents, OnClickOnItem, OnItemFocused, OnIsChangingItem;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.BeginVertical(MalbersEditor.StyleGray);
            {
                ...
                EditorGUILayout.BeginVertical(EditorStyles.helpBox);
                EditorGUI.indentLevel++;
                EditorInput.boolValue = EditorGUILayout.Foldout(EditorInput.boolValue, "Inputs");
                EditorGUI.indentLevel--;

                if (EditorInput.boolValue)
                {
