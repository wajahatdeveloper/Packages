...
public class SpecialButton : MonoBehaviour
{
    ...
    // Privacy Policy Link
    [ShowIf(nameof(buttonType),SpecialButtonType.PRIVACY_POLICY)]
    public string privacyPolicyLink = "www.google.com";
    
    // Rate Us Link
    //[ShowIf(nameof(buttonType),SpecialButtonType.RATE_US)]
    public string rateUsLink = "www.google.com";
    
    // More Games Link
    //[ShowIf(nameof(buttonType),SpecialButtonType.MORE_GAMES)]
    ...
    private void OnClick_ThisButton()
    {
        switch (buttonType)
        {
            ...
            case SpecialButtonType.RATE_US:
                gameObject.RaiseEvent(Event_RateUsClicked);
                break;
            case SpecialButtonType.MORE_GAMES:
                gameObject.RaiseEvent(Event_MoreGamesClicked);
                break;
            case SpecialButtonType.PRIVACY_POLICY:
                gameObject.RaiseEvent(Event_PrivacyPolicyClicked);
                break;
